...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Utilities for webvision challenge.')
    parser.add_argument(
        '--validate', help='increase output verbosity', action="store_true")
    parser.add_argument('--eval_val', help='evaluate validation dataset')
    parser.add_argument('--top_k', help='top k evaluation', type=int)
    parser.add_argument('--class_average',
                        help='average metric per class', action="store_true")
